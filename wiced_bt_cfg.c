...
#define WICED_DEVICE_NAME                       "L4SEC ENRIBeacon"
    ...
    uint8_t BT_LOCAL_NAME[] = { 'L', '4', 'S', 'E', 'C', ' ', 'B', 'L', 'E', ' ', ' ', ' ', ' ', '\0' };


/*****************************************************************************
 * wiced_bt core stack configuration
 ****************************************************************************/
 wiced_bt_cfg_settings_t app_cfg_settings =
{
    ...
    .ble_advert_cfg =                                               /* BLE advertisement settings */
    {
        ...
        .high_duty_duration              = 500,                                                        /**< High duty undirected connectable advertising duration in seconds (0 for infinite) */
